...
The big idea of Open Rack — going back to ORv1— is to stop putting a separate AC power supply in every server and instead run a centralized **DC busbar** down the back of the rack. Every shelf or server connects to that busbar, drawing DC power directly. This saves roughly 15–30% of power per rack compared to traditional racks where every box has its own PSU.[1-1]
